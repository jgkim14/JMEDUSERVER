...
class UnboundLocalErrorException(HTTPException):
    def __init__(self, detail: str = "Unbound Local Error"):
        super().__init__(status_code=500, detail=detail)
...
exception_handlers: Dict[Type[HTTPException], Callable[[Request, HTTPException], JSONResponse]] = {
    ...
    UnboundLocalErrorException: lambda request, exc: JSONResponse(
        status_code=exc.status_code,
